...
console.log(`Alex 買完課程了，他一共剩下 ${AlexBudget} 元`); // 剩下100

// ### 題目四：線稿圖截圖，看圖宣告變數
// 請參考資料夾內 q4.webp 圖片
// 請依照你看到的內容來嘗試設計變數和值（至少 3 個）
let classPackage = 2520;
let courseTime = 50;
let oneLesson = 180;
...
console.log(`Alex 的水壺還有 ${myWater}cc 的水`); // 1000cc
...
const groupLesson = 150;
totalBill = machineUsePrice*3 + groupLesson*2
console.log(
...
a = 13; // a 變數重新賦予 13 的數字型別
a = b + 4; // a 變數重新賦予 4 的數字型別
a - b; // 運算 4-0 不改變 a,b的值
b += 1; // b 變數重新賦予 1 的數字型別
...
let numberArr1 = [5, 10, 15]; // 宣告 numberArr1 並賦予 [5, 10, 15] 陣列
let numberArr2 = numberArr1; // 宣告 numberArr2 指向與 numberArr1 同個記憶體位置
numberArr2.push(20); // 在 numberArr2 陣列插入 20
numberArr2 = [25, 30, 35]; // numberArr2 指向一個新的陣列 [25, 30, 35] 不再指向 numberArr1 的記憶體位置
